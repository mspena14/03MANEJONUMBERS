...
console.group("Ejercicio 45");
// 45. Calcular el triple de 6.
let varPunto45 = 6
console.log(varPunto45 * 3)
console.groupEnd();

console.group("Ejercicio 46");
// 46. Calcular el cuadrado de 8.
let varPunto46 = 8
console.log(Math.pow(varPunto46, 2))
console.groupEnd();

console.group("Ejercicio 47");
// 47. Calcular el cubo de 4.
let varPunto47 = 4
console.log(Math.pow(varPunto47, 3))
console.groupEnd();

console.group("Ejercicio 48");
// 48. Calcular la suma de los primeros 15 números naturales.
console.log(sumNumeros(15))
console.groupEnd();

console.group("Ejercicio 49");
// 49. Calcular la resta entre 100 y 55.
console.log(100 - 55)
console.groupEnd();

console.group("Ejercicio 50");
// 50. Multiplicar 6 por 8.
console.log(6 * 8)
console.groupEnd();

console.group("Ejercicio 51");
// 51. Dividir 225 por 15.
console.log(255 / 15)
console.groupEnd();

console.group("Ejercicio 52");
// 52. Obtener el módulo de 20 dividido por 7.
console.log(20 % 7)
console.groupEnd();

console.group("Ejercicio 53");
// 53. Generar un número aleatorio entre 40 y 50.

console.groupEnd();

console.group("Ejercicio 54");
// Ejercicio 54
console.groupEnd();

console.group("Ejercicio 55");
// Ejercicio 55
console.groupEnd();

console.group("Ejercicio 56");
// Ejercicio 56
console.groupEnd();

console.group("Ejercicio 57");
// Ejercicio 57
console.groupEnd();

console.group("Ejercicio 58");
// Ejercicio 58
console.groupEnd();

console.group("Ejercicio 59");
// Ejercicio 59
console.groupEnd();

console.group("Ejercicio 60");
// Ejercicio 60
console.groupEnd();

console.group("Ejercicio 61");
// Ejercicio 61
console.groupEnd();

console.group("Ejercicio 62");
// Ejercicio 62
console.groupEnd();

console.group("Ejercicio 63");
// Ejercicio 63
console.groupEnd();

console.group("Ejercicio 64");
// Ejercicio 64
console.groupEnd();

console.group("Ejercicio 65");
// Ejercicio 65
console.groupEnd();

console.group("Ejercicio 66");
// Ejercicio 66
console.groupEnd();

console.group("Ejercicio 67");
// Ejercicio 67
console.groupEnd();

console.group("Ejercicio 68");
// Ejercicio 68
console.groupEnd();

console.group("Ejercicio 69");
// Ejercicio 69
console.groupEnd();

console.group("Ejercicio 70");
// Ejercicio 70
console.groupEnd();

console.group("Ejercicio 71");
// Ejercicio 71
console.groupEnd();

console.group("Ejercicio 72");
// Ejercicio 72
console.groupEnd();

console.group("Ejercicio 73");
// Ejercicio 73
console.groupEnd();

console.group("Ejercicio 74");
// Ejercicio 74
console.groupEnd();

console.group("Ejercicio 75");
// Ejercicio 75
console.groupEnd();

console.group("Ejercicio 76");
// Ejercicio 76
console.groupEnd();

console.group("Ejercicio 77");
// Ejercicio 77
console.groupEnd();

console.group("Ejercicio 78");
// Ejercicio 78
console.groupEnd();

console.group("Ejercicio 79");
// Ejercicio 79
console.groupEnd();

console.group("Ejercicio 80");
// Ejercicio 80
console.groupEnd();

console.group("Ejercicio 81");
// Ejercicio 81
console.groupEnd();

console.group("Ejercicio 82");
// Ejercicio 82
console.groupEnd();

console.group("Ejercicio 83");
// Ejercicio 83
console.groupEnd();

console.group("Ejercicio 84");
// Ejercicio 84
console.groupEnd();

console.group("Ejercicio 85");
// Ejercicio 85
console.groupEnd();

console.group("Ejercicio 86");
// Ejercicio 86
console.groupEnd();

console.group("Ejercicio 87");
// Ejercicio 87
console.groupEnd();

console.group("Ejercicio 88");
// Ejercicio 88
console.groupEnd();

console.group("Ejercicio 89");
// Ejercicio 89
console.groupEnd();

console.group("Ejercicio 90");
// Ejercicio 90
console.groupEnd();

console.group("Ejercicio 91");
// Ejercicio 91
console.groupEnd();

console.group("Ejercicio 92");
// Ejercicio 92
console.groupEnd();

console.group("Ejercicio 93");
// Ejercicio 93
console.groupEnd();

console.group("Ejercicio 94");
// Ejercicio 94
console.groupEnd();

console.group("Ejercicio 95");
// Ejercicio 95
console.groupEnd();

console.group("Ejercicio 96");
// Ejercicio 96
console.groupEnd();
console.groupEnd()